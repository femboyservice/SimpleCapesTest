...
* **Local mode**: It will take the cape image from your computer. The image must be in **.minecraft/simplecapes/** directory. To switch to this mode, **/simplecapestest local \<image name>**. Don't forget to add the extension (.png, .jpg, .webp, etc.)
